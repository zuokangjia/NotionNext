...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'BlueMood', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '普通人|:D', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-sable-three.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion0, 博客1', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/zuokangjia', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BACKGROUND_LIGHT: '#f5f5f5', // use hex value, don't forget '#' e.g #fffefc
  BACKGROUND_DARK: '#2f343f', // use hex value, don't forget '#'
